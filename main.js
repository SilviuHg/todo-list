...
const checkTodayTodo = function () {
  ...
  for (let i = 0; i < _toDo__WEBPACK_IMPORTED_MODULE_0__.toDoArray.length; i++) {
    if (_toDo__WEBPACK_IMPORTED_MODULE_0__.toDoArray[i].dueDate === currentDate) {
      console.log("true");
    } else {
      console.log("false");
    }
